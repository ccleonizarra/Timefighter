package com.example.timefighter.ui.screen
...
import com.example.timefighter.model.MarsPhoto
import com.example.timefighter.ui.theme.MarsPhotosTheme
...
fun ErrorScreen(retryAction: () -> Unit, modifier: Modifier = Modifier) {
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.nico), contentDescription = ""
        )
...
fun MarsPhotoCard(photo: MarsPhoto, modifier: Modifier = Modifier) {
    Card(
        ...
        AsyncImage(
            ...
            error = painterResource(R.drawable.nico),
            placeholder = painterResource(R.drawable.nico),
            contentDescription = stringResource(R.string.app_name),
